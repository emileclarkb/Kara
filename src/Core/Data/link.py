from Core.Abilities.Kara_Time.main import currentDate
...
from Core.Abilities.Kara_Weather.main import sunrise
from Core.Abilities.Kara_Weather.main import sunset
